...
_ADAPTER_FAILURE_CODES = {
    ...
    "TOTAL_ROW_DIMENSION_COUNT_INVALID": "TOTAL_ROW_DIMENSION_COUNT_INVALID",
    "TOTAL_ROW_DIMENSION_VALUE_INVALID": "TOTAL_ROW_DIMENSION_VALUE_INVALID",
    "TOTAL_ROW_METRIC_COUNT_INVALID": "TOTAL_ROW_METRIC_COUNT_INVALID",
    "TOTAL_METRIC_VALUE_INVALID": "TOTAL_METRIC_VALUE_INVALID",
    "LANDING_ROW_DIMENSION_COUNT_INVALID": (
        "LANDING_ROW_DIMENSION_COUNT_INVALID"
    ),
    "LANDING_ROW_DIMENSION_VALUE_INVALID": (
    ...
    "LANDING_ROW_METRIC_COUNT_INVALID": "LANDING_ROW_METRIC_COUNT_INVALID",
    "LANDING_METRIC_VALUE_INVALID": "LANDING_METRIC_VALUE_INVALID",
